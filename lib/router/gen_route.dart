...
import 'package:biatest/presentation/splash/splash_page.dart';
import 'package:biatest/presentation/user/user_screen.dart';
...
Route<Object>? generateRoute(RouteSettings settings) {
  ...
  switch (namedRoute.appRoute) {
    case AppRoute.unknown:
      return _errorRoute();
    case AppRoute.home:
      return _buildRoute(settings: settings, screen: const UserScreen());
    case AppRoute.root:
